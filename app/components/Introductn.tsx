...
const Introductn = () => {
    return (
        <main className='lg:flex justify-center my-[100px] overflow-hidden  w-full' >
            <section className=' '>
                <h3 className='text-[18px] leading-[150%] font-bold tracking-[12.06px] text-center lg:text-left aos-animate lg:ml-[20px] lg:mb-[11px] ' data-aos="fade-up">INTRODUCTING</h3>
                ...
                <p className='lg:text-[24px] text-[18px] text-center lg:text-left leading-[170%] mb-[40px] font  ' data-aos="fade-up">The mischievous monkey with a knack for causing chaos and spreading laughter on base. </p>
                <CopyButton />
