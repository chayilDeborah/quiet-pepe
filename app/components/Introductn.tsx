...
const Introductn = () => {
    return (
        <main className='lg:flex justify-center my-[100px]  w-full' >
            <section className=' '>
                <h3 className='text-[18px] leading-[150%] font-bold tracking-[12.06px] text-center lg:text-left aos-animate ' data-aos="fade-up">INTRODUCTION</h3>
                <h1 className='text-[72px] lg:text-[188px] mb-[16px] leading-[90%] h1 font-bold mb-[36px] text-center lg:text-left mt-[15px] lg:mt-[0px] ' data-aos="fade-up">$GONZO</h1>
                <p className='lg:text-[22px] text-[18px] text-center lg:text-left leading-[170%] mb-[40px]  ' data-aos="fade-up">The mischievous monkey with a knack for causing chaos and spreading laughter on base. </p>
                <CopyButton />
