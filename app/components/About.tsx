        ...
        <main className='flex justify-center w-full mt-[350px] lg:mt-[100px] text-white ' id='about'>
            <section className='w-full'>
                <div className='flex flex-col-reverse lg:flex-row justify-between'>
                    ...
                    <section className='mt-[90px] lg:ml-[30px] '>
                        ...
                        <div className='lg:w-[717px] lg:text-[24px] text-[18px] text-center lg:text-leftleading-[180%]  '>This mischievous monkey is notorious for his light-fingered antics and his uncanny ability to outwit even the most vigilant of netizens.
