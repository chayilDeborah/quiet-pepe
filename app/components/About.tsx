        ...
        <main className='flex justify-center w-full mt-[150px] lg:mt-[100px] text-white overflow-hidden ' id='about'>
            <section className='w-full'>
                <div className='flex flex-col-reverse lg:flex-row justify-between'>
                    ...
                    <Image src={tv} alt='gif' className="lg:w-[566px] mt-[40px] lg:mt-[0px] w-[90%] mx-auto lg:mx-[0px] h-[420px] lg:h-[616px] " /> 
                    </section>
                    <section className='lg:mt-[90px] lg:ml-[30px] ' data-aos="fade-left">
                        ...
                        <div className='lg:w-[717px] lg:text-[24px] text-[18px] text-center lg:text-left leading-[180%] font-rocknroll '>This mischievous monkey is notorious for his light-fingered antics and his uncanny ability to outwit even the most vigilant of netizens.
