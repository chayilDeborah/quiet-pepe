            ...
            <div className='lg:max-w-[90rem] w-[95%] mx-auto lg:w-full'>
                <div className='lg:flex justify-between '>
                    <section>
                        ...
                        <p className='lg:w-[792px] text-[18px] lg:text-[24px] leading-[180%] text-center lg:text-left text-[#000] ' data-aos="fade-up" data-duration="1600">As Gunzo swings through the digital jungle, gathering memes and causing mischief, his gang of loyal followers grows stronger with each laugh shared. Together, we fuel our meme arsenal, amplifying the hilarity and spreading joy across cyberspace.</p>
                        <div className='flex w-[140px] mt-[40px] justify-center lg:justify-between mx-auto lg:mx-[0px]  ' data-aos="fade-up" data-duration="1800">
